...
from tensorflow.keras.layers import Dense, Input, Embedding, LSTM, Bidirectional, Masking
...
def model_with_fasttext(train_sent, test_sent, \
        train_denom, test_denom, \
...
def train_and_test_fasttext(trainset, testset, args):
    ...
    return model_with_fasttext(train_sent, test_sent, train_denom, test_denom, train_label, test_label, tokenizer, args)
